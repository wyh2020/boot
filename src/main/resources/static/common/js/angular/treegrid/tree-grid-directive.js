(function() {
        ...
        .run([
            ...
            function($templateCache) {
                $templateCache.put('template/treeGrid/treeGrid.html',
                    ...
                    "<td width='40'><input ng-click=\"user_clicks_branch(row.branch)\"  ng-model='row.branch.isSelected' name='category' type='checkbox' value='row.branch.categoryId'></td>" +
    ...
    .filter('searchFor', function() {
        return function(arr, filterString, expandingProperty, colDefinitions, expand) {
            var filtered = [];
            //only apply filter for strings 2 characters long or more
